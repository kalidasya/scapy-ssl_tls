...
class TestPKCS7Encoder(unittest.TestCase):
    ...
    def test_pkcs7_encoder_returns_expected_padding_on_short_block(self):
        ...
        self.assertEqual(pkcs7_data[len(data):].decode('utf-8'), chr(self.pkcs7.k - len(data)) * (self.pkcs7.k - len(data)))
    ...
    def test_pkcs7_padding_only_is_returned_on_get_padding_call(self):
        ...
        self.assertEqual(chr(len(pkcs7_padding)) * len(pkcs7_padding), pkcs7_padding.decode('utf-8'))
